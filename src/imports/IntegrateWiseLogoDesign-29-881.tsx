...
import svgPaths from "./svg-8kxliygw21";
...
function TextBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<TextBackgroundImageProps>) {
  return (
    <div className={clsx("h-[24px] relative rounded-[33554400px] shrink-0", additionalClassNames)}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[10px] py-[4px] relative size-full">{children}</div>
    </div>
  );
}
  ...
  return (
    <div className={clsx("h-[16px] relative shrink-0", additionalClassNames)}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#bcc3d4] text-[12px] whitespace-nowrap">{text}</p>
      </div>
    </div>
  );
}
...
function ParagraphBackgroundImageAndText7({ text }: ParagraphBackgroundImageAndText7Props) {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#9ba8c2] text-[12px]">{text}</p>
    </div>
  );
}
...
function ParagraphBackgroundImageAndText6({ text, additionalClassNames = "" }: ParagraphBackgroundImageAndText6Props) {
  return (
    <div className={clsx("absolute h-[16px] left-0 w-[261.5px]", additionalClassNames)}>
      <p className="absolute font-['Menlo:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#7b8aad] text-[12px] top-0 whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function BackgroundImageAndText2({ text }: BackgroundImageAndText2Props) {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-0 top-0 w-[261.5px]">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] min-h-px min-w-px not-italic relative text-[#2f3d5e] text-[12px]">{text}</p>
    </div>
  );
}
...
function ParagraphBackgroundImageAndText4({ text, additionalClassNames = "" }: ParagraphBackgroundImageAndText4Props) {
  return (
    <div className={clsx("h-[20px] relative shrink-0 w-full", additionalClassNames)}>
...
function BackgroundImageAndText1({ text, additionalClassNames = "" }: BackgroundImageAndText1Props) {
  return (
    <div className={clsx("absolute h-[24px] left-[24px] top-[88px]", additionalClassNames)}>
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#0c0c0c] text-[16px] top-0 tracking-[-0.3125px] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function ParagraphBackgroundImageAndText2({ text }: ParagraphBackgroundImageAndText2Props) {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-[rgba(255,255,255,0.65)] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
export default function IntegrateWiseLogoDesign() {
  return (
    <div className="bg-[#edf0f5] content-stretch flex items-start relative size-full" data-name="IntegrateWise Logo Design">
              ...
              <div className="h-[36.5px] relative shrink-0 w-[94.031px]" data-name="Container">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
                  <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
                    <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[#0c0c0c] text-[14px] top-0 tracking-[-0.1504px] whitespace-nowrap">IntegrateWise</p>
                  </div>
            ...
            <div className="overflow-clip rounded-[inherit] size-full">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start pt-[16px] px-[16px] relative size-full">
                <LinkBackgroundImage additionalClassNames="bg-[#1a3a2a]">
                  ...
                  <BackgroundImage2 additionalClassNames="h-[20px] w-[60.203px]">
                    <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-white top-0 tracking-[-0.1504px] whitespace-nowrap">Overview</p>
                  </BackgroundImage2>
                </LinkBackgroundImage>
                <LinkBackgroundImage>
                  <BackgroundImage1>
      ...
      <ContainerBackgroundImage1 additionalClassNames="h-[895px]">
        <div className="bg-[var(--paper)] h-[64px] relative shrink-0 w-[1263px]" data-name="Header">
          ...
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-px pl-[24px] relative size-full">
            <BackgroundImage2 additionalClassNames="h-[28px] w-[78.891px]">
              <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] left-0 not-italic text-[#0c0c0c] text-[18px] top-0 tracking-[-0.4395px] whitespace-nowrap">Overview</p>
            </BackgroundImage2>
          </div>
        </div>
        <div className="flex-[1_0_0] min-h-px min-w-px relative w-[1263px]" data-name="Main Content">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pr-[15px] relative rounded-[inherit] size-full">
            <div className="h-[2006px] relative shrink-0 w-full" data-name="HomePage">
              <div className="content-stretch flex flex-col gap-[40px] items-start pt-[40px] px-[40px] relative size-full">
                <div className="h-[398px] overflow-clip relative rounded-[16px] shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(161.183deg, rgb(26, 58, 42) 0%, rgb(54, 71, 137) 50%, rgb(184, 148, 63) 100%)" }}>
                  <div className="absolute h-[398px] left-0 opacity-10 top-0 w-[1168px]" data-name="Container">
                    <div className="absolute bg-[rgba(255,255,255,0.2)] left-[801.59px] rounded-[33554400px] size-[600px] top-[-199px]" data-name="Container" />
                    <div className="absolute bg-[rgba(255,255,255,0.1)] left-[-116.8px] rounded-[33554400px] size-[400px] top-[157.19px]" data-name="Container" />
                  </div>
                  <div className="absolute h-[302px] left-[48px] top-[48px] w-[1072px]" data-name="Container">
                    <div className="absolute content-stretch flex gap-[16px] h-[62px] items-center left-0 top-0 w-[1072px]" data-name="IntegrateWiseLogo">
                      ...
                      <div className="h-[62px] relative shrink-0 w-[419.219px]" data-name="Container">
                        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start relative size-full">
                          <div className="flex-[1_0_0] min-h-px min-w-px relative w-[419.219px]" data-name="Heading 1">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
                          ...
                          <BackgroundImage2 additionalClassNames="h-[24px] w-[419.219px]">
                            <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-[rgba(255,255,255,0.8)] top-0 tracking-[0.0875px] whitespace-nowrap">Knowledge Workspace Empowered by AI and the Spine</p>
                          </BackgroundImage2>
                        </div>
                      </div>
                    </div>
                    <div className="absolute content-stretch flex flex-col gap-[8px] h-[116px] items-start left-0 top-[86px] w-[576px]" data-name="Container">
                      ...
                      <div className="h-[72px] relative shrink-0 w-full" data-name="Paragraph">
                        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-[rgba(255,255,255,0.75)] top-0 tracking-[-0.3125px] w-[527px]">Your centralized hub for brand assets, corporate stationery, marketing collateral, and sales enablement materials. Everything to represent IntegrateWise consistently across legal, finance, product, and marketing.</p>
                      </div>
                    </div>
                    <div className="absolute h-[68px] left-0 top-[234px] w-[1072px]" data-name="Container">
                      <div className="absolute bg-[rgba(255,255,255,0.15)] content-stretch flex gap-[12px] h-[68px] items-center left-0 px-[20px] rounded-[10px] top-0 w-[140.719px]" data-name="Container">
                        <BackgroundImage>
                      ...
                      <div className="absolute bg-[rgba(255,255,255,0.15)] content-stretch flex gap-[12px] h-[68px] items-center left-[156.72px] px-[20px] rounded-[10px] top-0 w-[130.125px]" data-name="Container">
                        <BackgroundImage>
                      ...
                      <div className="absolute bg-[rgba(255,255,255,0.15)] content-stretch flex gap-[12px] h-[68px] items-center left-[302.84px] px-[20px] rounded-[10px] top-0 w-[133.422px]" data-name="Container">
                        <BackgroundImage>
                ...
                <div className="bg-[var(--paper)] h-[251px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
                  ...
                  <div className="content-stretch flex flex-col gap-[16px] items-start pb-px pt-[33px] px-[33px] relative size-full">
                    <div className="content-stretch flex gap-[8px] h-[24px] items-center relative shrink-0 w-full" data-name="Container">
                      <BackgroundImage>
                        <path d={svgPaths.p28150300} id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                        <path d={svgPaths.p8bc2f80} id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                      </BackgroundImage>
                      <BackgroundImage2 additionalClassNames="h-[24px] w-[262.266px]">
                        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#0c0c0c] text-[16px] top-0 tracking-[-0.3125px] whitespace-nowrap">Brand Positioning Quick Reference</p>
                      </BackgroundImage2>
                    </div>
                    <div className="h-[145px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[4px] h-[60.5px] items-start left-0 top-0 w-[351.328px]" data-name="Container">
                        <ParagraphBackgroundImageAndText3 text="CORE DESCRIPTOR" />
                        <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
                          <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#2f3d5e] text-[14px] top-0 tracking-[-0.1504px] w-[323px]">Knowledge Workspace Empowered by AI and the Spine</p>
                        </div>
                      </div>
                      <div className="absolute content-stretch flex flex-col gap-[4px] h-[60.5px] items-start left-[375.33px] top-0 w-[351.328px]" data-name="Container">
                        <ParagraphBackgroundImageAndText3 text="PRIMARY TAGLINE" />
                        <ParagraphBackgroundImageAndText4 text="AI Thinks in Context — and Waits for Approval" />
                      </div>
                      <div className="absolute content-stretch flex flex-col gap-[4px] h-[60.5px] items-start left-[750.66px] top-0 w-[351.344px]" data-name="Container">
                      ...
                      <div className="absolute content-stretch flex flex-col gap-[4px] h-[60.5px] items-start left-0 top-[84.5px] w-[1102px]" data-name="Container">
                        <ParagraphBackgroundImageAndText3 text="PRODUCT ESSENCE" />
                        <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
                          <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#475578] text-[14px] top-0 tracking-[-0.1504px] w-[1079px]">IntegrateWise is a knowledge workspace where the Spine becomes the single source of truth and AI operates on top of that context — thinking, proposing, and learning while every action remains under human approval.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="content-stretch flex flex-col gap-[16px] h-[512px] items-start relative shrink-0 w-full" data-name="Container">
                  <BackgroundImageAndText text="Browse Categories" />
                  <div className="h-[468px] relative shrink-0 w-full" data-name="Container">
                    <div className="absolute bg-[var(--paper)] border border-[#D8D0C0] border-solid h-[222px] left-0 rounded-[14px] top-0 w-[373.328px]" data-name="Button">
                      <div className="absolute content-stretch flex h-[48px] items-start justify-between left-[24px] top-[24px] w-[323.328px]" data-name="Container">
                        <ContainerBackgroundImage2 additionalClassNames="bg-[rgba(65,84,163,0.07)]">
                          <IconBackgroundImage1>
                            <path d={svgPaths.p2476dfc0} fill="var(--fill-0, #1A3A2A)" id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            <path d={svgPaths.pf6f2500} fill="var(--fill-0, #1A3A2A)" id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            <path d={svgPaths.p2f047a30} fill="var(--fill-0, #1A3A2A)" id="Vector_3" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            <path d={svgPaths.p7aea480} fill="var(--fill-0, #1A3A2A)" id="Vector_4" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            <path d={svgPaths.p3eb1d9c0} id="Vector_5" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                          </IconBackgroundImage1>
                        </ContainerBackgroundImage2>
                        <IconBackgroundImage />
                      </div>
                      <BackgroundImageAndText1 text="Brand Assets" additionalClassNames="w-[323.328px]" />
                      <div className="absolute h-[40px] left-[24px] top-[116px] w-[323.328px]" data-name="Paragraph">
                        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#7b8aad] text-[14px] top-0 tracking-[-0.1504px] w-[298px]">Logo system, brand messaging, taglines, and visual identity guidelines</p>
                      </div>
                      <div className="absolute content-stretch flex h-[24px] items-center left-[24px] top-[172px] w-[323.328px]" data-name="Container">
                        <TextBackgroundImage additionalClassNames="bg-[rgba(65,84,163,0.07)] w-[68.344px]">
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1a3a2a] text-[12px] whitespace-nowrap">5 assets</p>
                        </TextBackgroundImage>
                      </div>
                    </div>
                    <div className="absolute bg-[var(--paper)] border border-[#D8D0C0] border-solid h-[222px] left-[397.33px] rounded-[14px] top-0 w-[373.328px]" data-name="Button">
                      <div className="absolute content-stretch flex h-[48px] items-start justify-between left-[24px] top-[24px] w-[323.328px]" data-name="Container">
                      ...
                      <BackgroundImageAndText1 text="Design Tokens" additionalClassNames="w-[323.328px]" />
                      <div className="absolute h-[40px] left-[24px] top-[116px] w-[323.328px]" data-name="Paragraph">
                        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#7b8aad] text-[14px] top-0 tracking-[-0.1504px] w-[297px]">Colors, typography, spacing, and component foundations</p>
                      </div>
                      <div className="absolute content-stretch flex h-[24px] items-center left-[24px] top-[172px] w-[323.328px]" data-name="Container">
                        <TextBackgroundImage additionalClassNames="bg-[rgba(107,125,196,0.07)] w-[107.125px]">
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#6b7dc4] text-[12px] whitespace-nowrap">8 token groups</p>
                        </TextBackgroundImage>
                      </div>
                    </div>
                    <div className="absolute bg-[var(--paper)] border border-[#D8D0C0] border-solid h-[222px] left-[794.66px] rounded-[14px] top-0 w-[373.344px]" data-name="Button">
                      <div className="absolute content-stretch flex h-[48px] items-start justify-between left-[24px] top-[24px] w-[323.344px]" data-name="Container">
                      ...
                      <BackgroundImageAndText1 text="Stationery" additionalClassNames="w-[323.344px]" />
                      <div className="absolute h-[40px] left-[24px] top-[116px] w-[323.344px]" data-name="Paragraph">
                        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#7b8aad] text-[14px] top-0 tracking-[-0.1504px] w-[293px]">Letterhead, invoice, proposal, seal, business card, email signature</p>
                      </div>
                      <div className="absolute content-stretch flex h-[24px] items-center left-[24px] top-[172px] w-[323.344px]" data-name="Container">
                        <TextBackgroundImage additionalClassNames="bg-[rgba(54,71,137,0.07)] w-[88.688px]">
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#364789] text-[12px] whitespace-nowrap">8 templates</p>
                        </TextBackgroundImage>
                      </div>
                    </div>
                    <div className="absolute bg-[var(--paper)] border border-[#D8D0C0] border-solid h-[222px] left-0 rounded-[14px] top-[246px] w-[373.328px]" data-name="Button">
                      <div className="absolute content-stretch flex h-[48px] items-start justify-between left-[24px] top-[24px] w-[323.328px]" data-name="Container">
                        <ContainerBackgroundImage2 additionalClassNames="bg-[rgba(235,67,121,0.07)]">
                          <IconBackgroundImage1>
                            <path d="M3 11L21 6V18L3 14V11Z" id="Vector" stroke="var(--stroke-0, #B8943F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            <path d={svgPaths.paa5e400} id="Vector_2" stroke="var(--stroke-0, #B8943F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                          </IconBackgroundImage1>
                        </ContainerBackgroundImage2>
                        <IconBackgroundImage />
                      </div>
                      <BackgroundImageAndText1 text="Marketing" additionalClassNames="w-[323.328px]" />
                      <div className="absolute h-[40px] left-[24px] top-[116px] w-[323.328px]" data-name="Paragraph">
                        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#7b8aad] text-[14px] top-0 tracking-[-0.1504px] w-[296px]">Social templates, LinkedIn assets, WhatsApp catalog, marketing one-pagers</p>
                      </div>
                      <div className="absolute content-stretch flex h-[24px] items-center left-[24px] top-[172px] w-[323.328px]" data-name="Container">
                        <TextBackgroundImage additionalClassNames="bg-[rgba(235,67,121,0.07)] w-[106.844px]">
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#b8943f] text-[12px] whitespace-nowrap">14 deliverables</p>
                        </TextBackgroundImage>
                      </div>
                    </div>
                    <div className="absolute bg-[var(--paper)] border border-[#D8D0C0] border-solid h-[222px] left-[397.33px] rounded-[14px] top-[246px] w-[373.328px]" data-name="Button">
                      <div className="absolute content-stretch flex h-[48px] items-start justify-between left-[24px] top-[24px] w-[323.328px]" data-name="Container">
                      ...
                      <BackgroundImageAndText1 text="Sales" additionalClassNames="w-[323.328px]" />
                      <div className="absolute h-[40px] left-[24px] top-[116px] w-[323.328px]" data-name="Paragraph">
                        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#7b8aad] text-[14px] top-0 tracking-[-0.1504px] w-[256px]">Pitch decks, one-pagers, case studies, battlecards, and proposals</p>
                      </div>
                      <div className="absolute content-stretch flex h-[24px] items-center left-[24px] top-[172px] w-[323.328px]" data-name="Container">
                        <TextBackgroundImage additionalClassNames="bg-[rgba(208,53,104,0.07)] w-[106.719px]">
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#d03568] text-[12px] whitespace-nowrap">10 deliverables</p>
                        </TextBackgroundImage>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="content-stretch flex flex-col gap-[16px] h-[215px] items-start relative shrink-0 w-full" data-name="Container">
                  <BackgroundImageAndText text="Official Contact System" />
                  <div className="bg-[var(--paper)] h-[171px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
                    <div aria-hidden="true" className="absolute border border-[#D8D0C0] border-solid inset-0 pointer-events-none rounded-[14px]" />
                    <div className="content-stretch flex flex-col gap-[16px] items-start pb-px pt-[25px] px-[25px] relative size-full">
                      <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[56px] relative shrink-0 w-full" data-name="Container">
                        <div className="col-1 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                          ...
                          <ParagraphBackgroundImageAndText6 text="info@integratewise.co" additionalClassNames="top-[24px]" />
                          <ParagraphBackgroundImageAndText6 text="connect@integratewise.co" additionalClassNames="top-[40px]" />
                        </div>
                        <div className="col-2 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                          ...
                          <ParagraphBackgroundImageAndText6 text="sales@integratewise.co" additionalClassNames="top-[24px]" />
                          <ParagraphBackgroundImageAndText6 text="sales@integratewise.ai" additionalClassNames="top-[40px]" />
                        </div>
                        <div className="col-3 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                          ...
                          <ParagraphBackgroundImageAndText6 text="support@integratewise.co" additionalClassNames="top-[24px]" />
                          <ParagraphBackgroundImageAndText6 text="support@integratewise.ai" additionalClassNames="top-[40px]" />
                        </div>
                        <div className="col-4 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                          ...
                          <ParagraphBackgroundImageAndText6 text="billing@integratewise.co" additionalClassNames="top-[24px]" />
                          <ParagraphBackgroundImageAndText6 text="billing@integratewise.ai" additionalClassNames="top-[40px]" />
                        </div>
                      </div>
                      <div className="h-[49px] relative shrink-0 w-full" data-name="Container">
                        ...
                        <div className="absolute content-stretch flex flex-col h-[32px] items-start left-0 top-[17px] w-[187.844px]" data-name="Container">
                          <ParagraphBackgroundImageAndText5 text="Marketing" />
                        ...
                        <div className="absolute content-stretch flex flex-col h-[32px] items-start left-[211.84px] top-[17px] w-[173.391px]" data-name="Container">
                          <ParagraphBackgroundImageAndText5 text="Careers" />
                          <BackgroundImageAndText3 text="careers@integratewise.co" />
                        </div>
                        <div className="absolute content-stretch flex flex-col h-[32px] items-start left-[409.23px] top-[17px] w-[180.625px]" data-name="Container">
                          <ParagraphBackgroundImageAndText5 text="Security" />
                          <BackgroundImageAndText3 text="security@integratewise.co" />
                        </div>
                        <div className="absolute content-stretch flex flex-col h-[32px] items-start left-[613.86px] top-[17px] w-[115.594px]" data-name="Container">
                          <ParagraphBackgroundImageAndText5 text="Website" />
                ...
                <div className="content-stretch flex flex-col gap-[16px] h-[390px] items-start relative shrink-0 w-full" data-name="Container">
                  ...
                  <div className="bg-[var(--paper)] h-[346px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
                    <div aria-hidden="true" className="absolute border border-[#D8D0C0] border-solid inset-0 pointer-events-none rounded-[14px]" />
                    <div className="content-stretch flex flex-col items-start p-px relative size-full">
                      <ContainerBackgroundImage>
                        <div className="bg-[#1a3a2a] rounded-[33554400px] shrink-0 size-[8px]" data-name="Container" />
                        <ContainerBackgroundImage1 additionalClassNames="h-[36px]">
                          <ParagraphBackgroundImageAndText4 text="Logo Mark v2 Updated" additionalClassNames="overflow-clip" />
                          <ParagraphBackgroundImageAndText7 text="Brand Assets" />
                        </ContainerBackgroundImage1>
                        <TextBackgroundImageAndText text="Mar 14, 2026" additionalClassNames="w-[74.563px]" />
                      </ContainerBackgroundImage>
                      <ContainerBackgroundImage>
                        <div className="bg-[#364789] rounded-[33554400px] shrink-0 size-[8px]" data-name="Container" />
                        <ContainerBackgroundImage1 additionalClassNames="h-[36px]">
                          <ParagraphBackgroundImageAndText4 text="Corporate Stationery Suite Published" additionalClassNames="overflow-clip" />
                      ...
                      <ContainerBackgroundImage>
                        <div className="bg-[#d03568] rounded-[33554400px] shrink-0 size-[8px]" data-name="Container" />
                        <ContainerBackgroundImage1 additionalClassNames="h-[36px]">
                          <ParagraphBackgroundImageAndText4 text="Q1 Sales Deck Published" additionalClassNames="overflow-clip" />
                          <ParagraphBackgroundImageAndText7 text="Sales" />
                        </ContainerBackgroundImage1>
                        <TextBackgroundImageAndText text="Mar 12, 2026" additionalClassNames="w-[74.313px]" />
                      </ContainerBackgroundImage>
                      <ContainerBackgroundImage>
                        <div className="bg-[#b8943f] rounded-[33554400px] shrink-0 size-[8px]" data-name="Container" />
                        <ContainerBackgroundImage1 additionalClassNames="h-[36px]">
                          <div className="h-[20px] overflow-clip relative shrink-0 w-full" data-name="Paragraph">
                            <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#2f3d5e] text-[14px] top-0 tracking-[-0.1504px] whitespace-nowrap">{`LinkedIn & WhatsApp Assets Added`}</p>
                          </div>
                          <ParagraphBackgroundImageAndText7 text="Marketing" />
                        </ContainerBackgroundImage1>
                        <TextBackgroundImageAndText text="Mar 10, 2026" additionalClassNames="w-[74.344px]" />
                      </ContainerBackgroundImage>
                      <div className="h-[68px] relative shrink-0 w-full" data-name="Container">
                        <div className="flex flex-row items-center size-full">
                          <div className="content-stretch flex gap-[16px] items-center px-[24px] relative size-full">
                            <div className="bg-[#6b7dc4] rounded-[33554400px] shrink-0 size-[8px]" data-name="Container" />
                            <ContainerBackgroundImage1 additionalClassNames="h-[36px]">
                              <ParagraphBackgroundImageAndText4 text="Design Tokens v1.0 Finalized" additionalClassNames="overflow-clip" />
                              <ParagraphBackgroundImageAndText7 text="Design Tokens" />
                            </ContainerBackgroundImage1>
                            <TextBackgroundImageAndText text="Mar 8, 2026" additionalClassNames="w-[68.938px]" />
                          </div>
                        </div>
                      </div>
                    </div>
