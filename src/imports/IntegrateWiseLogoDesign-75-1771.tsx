...
function TextInputBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<TextInputBackgroundImageProps>) {
  return (
    <div className={clsx("absolute h-[27px] rounded-[4px] top-0 w-[198.219px]", additionalClassNames)}>
      ...
      <div aria-hidden="true" className="absolute border border-[#D8D0C0] border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
  );
}
...
function ParagraphBackgroundImageAndText3({ text }: ParagraphBackgroundImageAndText3Props) {
  return (
    <div className="h-[20px] overflow-clip relative shrink-0 w-full">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0c0c0c] text-[14px] top-0 tracking-[-0.1504px] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function TableCellBackgroundImageAndText({ text, additionalClassNames = "" }: TableCellBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute h-[16.5px] top-0", additionalClassNames)}>
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[16.5px] left-0 not-italic text-[#1a3a2a] text-[11px] top-0 whitespace-nowrap">{text}</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(65,84,163,0.08)] flex-[1_0_0] h-[28px] min-h-px min-w-px relative rounded-[8px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <IconBackgroundImage />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[47.5px] not-italic text-[#1a3a2a] text-[12px] text-center top-[6px] whitespace-nowrap">{text}</p>
      </div>
    </div>
  );
}
...
function ContainerBackgroundImageAndText({ text }: ContainerBackgroundImageAndTextProps) {
  return (
    <div className="bg-[#1a3a2a] relative rounded-[33554400px] shrink-0 size-[32px]">
    ...
    <div className="absolute left-[12px] size-[12px] top-[8px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g clipPath="url(#clip0_75_1789)" id="Icon">
          <path d={svgPaths.p23fe4800} id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p99a3180} id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
            ...
            <div className="h-[766.5px] relative shrink-0 w-full" data-name="GeneratorsPage">
              <div className="content-stretch flex flex-col gap-[32px] items-start pt-[40px] px-[40px] relative size-full">
                <div className="h-[60px] relative shrink-0 w-full" data-name="Container">
                  ...
                  <div className="absolute bg-[#EBE5D8] h-[32px] left-[1035.91px] rounded-[10px] top-0 w-[147.094px]" data-name="Button">
                ...
                <div className="content-stretch flex gap-[24px] h-[594.5px] items-start relative shrink-0 w-full" data-name="Container">
                    ...
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
                      ...
                      <ButtonBackgroundImage1>
                        <ContainerBackgroundImage3 additionalClassNames="bg-[rgba(65,84,163,0.07)] size-[36px]">
                          <IconBackgroundImage3>
                            <path d={svgPaths.p19d57600} id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            <path d={svgPaths.p2fe1fe40} id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            <path d={svgPaths.p2c494540} id="Vector_3" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                          </IconBackgroundImage3>
                        </ContainerBackgroundImage3>
                        <ContainerBackgroundImage2 additionalClassNames="flex-[174_0_0] h-[36.5px]">
                          <div className="content-stretch flex h-[20px] items-center relative shrink-0 w-full" data-name="Container">
                      ...
                      <BackgroundImage additionalClassNames="bg-[#1a3a2a] rounded-[14px]">
                  ...
                  <div className="bg-[var(--paper)] flex-[1_0_0] h-[594.5px] min-h-px min-w-px relative rounded-[14px]" data-name="Container">
                    <div aria-hidden="true" className="absolute border border-[#D8D0C0] border-solid inset-0 pointer-events-none rounded-[14px]" />
                      ...
                      <div className="content-stretch flex gap-[12px] h-[61px] items-center pb-px relative shrink-0 w-full" data-name="Container">
                        ...
                        <BackgroundImage5 additionalClassNames="h-[40px] w-[148.016px]">
                          <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
                            <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#0c0c0c] text-[16px] top-0 tracking-[-0.3125px] whitespace-nowrap">{`Team & Signatures`}</p>
                          </div>
                          <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Paragraph">
                        ...
                        <div className="h-[28px] relative shrink-0 w-full" data-name="Container">
                          ...
                          <div className="absolute content-stretch flex gap-[8px] h-[28px] items-start left-[652px] top-0 w-[185px]" data-name="Container">
                            <div className="bg-[rgba(65,84,163,0.08)] flex-[1_0_0] h-[28px] min-h-px min-w-px relative rounded-[8px]" data-name="CopyBtn">
                              <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                                <IconBackgroundImage />
                                <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[68px] not-italic text-[#1a3a2a] text-[12px] text-center top-[6px] whitespace-nowrap">Copy All Sigs</p>
                              </div>
                            </div>
                            <BackgroundImage4 additionalClassNames="bg-[#EBE5D8] rounded-[8px] w-[59.016px]">
                              <IconBackgroundImage2 additionalClassNames="left-[10px] top-[8px]">
                                <path d="M2.5 6H9.5" id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M6 2.5V9.5" id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" />
                              </IconBackgroundImage2>
                              <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[38.5px] not-italic text-[#1a3a2a] text-[12px] text-center top-[6px] whitespace-nowrap">{` Add`}</p>
                            </BackgroundImage4>
                          </div>
                        </div>
                        <div className="content-stretch flex flex-col gap-[8px] h-[399.5px] items-start relative shrink-0 w-full" data-name="Container">
                          <div className="h-[258.5px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
                            <div className="overflow-clip relative rounded-[inherit] size-full">
                              <div className="absolute bg-[#EBE5D8] content-stretch flex gap-[12px] h-[56px] items-center left-px px-[16px] top-px w-[835px]" data-name="Container">
                                ...
                                <div className="flex-[610.672_0_0] h-[27px] min-h-px min-w-px relative" data-name="Container">
                                  <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                                    ...
                                    <div className="absolute bg-[var(--paper)] content-stretch flex flex-col h-[27px] items-start left-[412.44px] pb-px pl-[-1114.438px] pr-[1312.656px] pt-[-373.5px] rounded-[4px] top-0 w-[198.219px]" data-name="Dropdown">
                                      <div aria-hidden="true" className="absolute border border-[#D8D0C0] border-solid inset-0 pointer-events-none rounded-[4px]" />
                                ...
                                <BackgroundImage2>
                                  <BackgroundImage3>
                                    <div className="h-[14px] overflow-clip relative shrink-0 w-full" data-name="Icon">
                                      <VectorBackgroundImage1>
                                        <path d="M0.583333 0.583333H5.83333" id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                                      </VectorBackgroundImage1>
                                      <VectorBackgroundImage2>
                                        <path d={svgPaths.p9a58400} id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                                      </VectorBackgroundImage2>
                                    </div>
                                  </BackgroundImage3>
                                  <CopyBtnBackgroundImageAndText text="HTML" />
                              ...
                              <div className="absolute bg-[var(--paper)] content-stretch flex flex-col h-[180.5px] items-start left-[17px] pb-px pl-[17px] pr-[412.25px] pt-[17px] rounded-[10px] top-[65px] w-[803px]" data-name="Container">
                                    ...
                                    <div className="absolute h-[146.5px] left-0 top-0 w-[373.75px]" data-name="Table Row">
                                      ...
                                      <div className="absolute h-[146.5px] left-[64px] top-0 w-[309.75px]" data-name="Table Cell">
                                        <div className="absolute h-[22.5px] left-0 top-0 w-[309.75px]" data-name="Paragraph">
                                          <p className="absolute font-['Arial:Bold',sans-serif] leading-[22.5px] left-0 not-italic text-[#0c0c0c] text-[15px] top-0 whitespace-nowrap">Nirmal Prince J</p>
                                        </div>
                                        ...
                                        <div className="absolute border-[#1a3a2a] border-solid border-t h-[25.5px] left-0 top-[121px] w-[309.75px]" data-name="Paragraph">
                          ...
                          <ContainerBackgroundImage1>
                            <BackgroundImage additionalClassNames="bg-[var(--paper)]">
