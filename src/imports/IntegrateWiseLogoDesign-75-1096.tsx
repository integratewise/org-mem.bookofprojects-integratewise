...
import svgPaths from "./svg-rl5oe4mpx1";
...
function ContainerBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<ContainerBackgroundImageProps>) {
  return <BackgroundImage3 additionalClassNames={clsx("min-h-px min-w-px relative", additionalClassNames)}>{children}</BackgroundImage3>;
}
...
function TextInputBackgroundImageAndText({ text }: TextInputBackgroundImageAndTextProps) {
  return (
    <div className="h-[38px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-[rgba(27,37,68,0.5)] tracking-[-0.1504px] whitespace-nowrap">{text}</p>
        </div>
      </div>
...
function ButtonBackgroundImageAndText1({ text, additionalClassNames = "" }: ButtonBackgroundImageAndText1Props) {
  return (
    <div className={clsx("absolute bg-[#1a3a2a] content-stretch flex h-[28px] items-start px-[12px] py-[6px] rounded-[8px] top-0", additionalClassNames)}>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function ButtonBackgroundImageAndText({ text, additionalClassNames = "" }: ButtonBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute bg-[#EBE5D8] content-stretch flex h-[28px] items-start px-[12px] py-[6px] rounded-[8px] top-0", additionalClassNames)}>
...
function BackgroundImageAndText({ text, additionalClassNames = "" }: BackgroundImageAndTextProps) {
  return (
    <div className={clsx("h-[16.5px] relative shrink-0 w-full", additionalClassNames)}>
        ...
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pr-px relative size-full">
          <div className="h-[64px] relative shrink-0 w-[287px]" data-name="Container">
            ...
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[33.262px] items-center pb-px pl-[24px] relative size-full">
              ...
              <BackgroundImage2 additionalClassNames="h-[36.5px] w-[94.031px]">
      ...
      <ContainerBackgroundImage additionalClassNames="flex-[1263_0_0] h-[895px]">
        <div className="bg-[var(--paper)] h-[64px] relative shrink-0 w-[1263px]" data-name="Header">
          ...
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-px pl-[24px] relative size-full">
            <div className="h-[28px] relative shrink-0 w-[146.922px]" data-name="Heading 1">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] left-0 not-italic text-[#0c0c0c] text-[18px] top-0 tracking-[-0.4395px] whitespace-nowrap">Quick Generators</p>
              </div>
            </div>
          </div>
        </div>
        <div className="flex-[831_0_0] min-h-px min-w-px relative w-[1263px]" data-name="Main Content">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip pr-[15px] relative rounded-[inherit] size-full">
            <div className="h-[999.938px] relative shrink-0 w-full" data-name="GeneratorsPage">
              <div className="content-stretch flex flex-col gap-[32px] items-start pt-[40px] px-[40px] relative size-full">
                <div className="h-[60px] relative shrink-0 w-full" data-name="Container">
                  <div className="absolute content-stretch flex flex-col gap-[4px] h-[60px] items-start left-0 top-0 w-[549.094px]" data-name="Container">
                    <div className="h-[32px] relative shrink-0 w-full" data-name="Heading 2">
                      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[32px] left-0 not-italic text-[#0c0c0c] text-[24px] top-0 tracking-[0.0703px] whitespace-nowrap">Quick Generators</p>
                    </div>
                  ...
                  <div className="absolute bg-[#EBE5D8] h-[32px] left-[1020.91px] rounded-[10px] top-0 w-[147.094px]" data-name="Button">
                ...
                <div className="content-stretch flex gap-[24px] h-[827.938px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="h-[827.938px] relative shrink-0 w-[256px]" data-name="Container">
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
                      <ButtonBackgroundImage>
                        <ContainerBackgroundImage1 additionalClassNames="bg-[rgba(235,67,121,0.07)] size-[36px]">
                          <IconBackgroundImage1>
                            <path d={svgPaths.p18993c00} id="Vector" stroke="var(--stroke-0, #B8943F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            <path d="M8 14.6667V8" id="Vector_2" stroke="var(--stroke-0, #B8943F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            <path d={svgPaths.p14df0fc0} id="Vector_3" stroke="var(--stroke-0, #B8943F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            <path d="M5 2.84667L11 6.28" id="Vector_4" stroke="var(--stroke-0, #B8943F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                          </IconBackgroundImage1>
                        ...
                        <ContainerBackgroundImage additionalClassNames="flex-[174_0_0] h-[36.5px]">
                          <div className="content-stretch flex gap-[6px] h-[20px] items-center relative shrink-0 w-full" data-name="Container">
                            ...
                            <div className="bg-[#b8943f] h-[17.5px] relative rounded-[33554400px] shrink-0 w-[34.109px]" data-name="Text">
                              <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                          ...
                          <BackgroundImageAndText text="One-click full export" additionalClassNames="opacity-70 overflow-clip" />
                        </ContainerBackgroundImage>
                      </ButtonBackgroundImage>
                      <ButtonBackgroundImage>
                        <ContainerBackgroundImage1 additionalClassNames="bg-[rgba(10,102,194,0.07)] size-[36px]">
                          <IconBackgroundImage1>
                        ...
                        <ContainerBackgroundImage additionalClassNames="flex-[174_0_0] h-[36.5px]">
                          ...
                          <BackgroundImageAndText text="1584x396, 4 styles" additionalClassNames="opacity-70 overflow-clip" />
                        </ContainerBackgroundImage>
                      </ButtonBackgroundImage>
                      <div className="bg-[#1a3a2a] h-[60.5px] relative rounded-[14px] shrink-0 w-full" data-name="Button">
                        <div className="flex flex-row items-center size-full">
                          <div className="content-stretch flex gap-[12px] items-center px-[16px] relative size-full">
                            <ContainerBackgroundImage1 additionalClassNames="bg-[rgba(255,255,255,0.15)] size-[36px]">
                              <IconBackgroundImage1>
                                ...
                                <path d={svgPaths.p2c494540} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                              </IconBackgroundImage1>
                            </ContainerBackgroundImage1>
                            <ContainerBackgroundImage additionalClassNames="flex-[176_0_0] h-[36.5px]">
                              <div className="content-stretch flex h-[20px] items-center relative shrink-0 w-full" data-name="Container">
                                <BackgroundImage1 additionalClassNames="w-[80.266px]">
                                  <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[14px] text-white top-0 tracking-[-0.1504px] whitespace-nowrap">Social Posts</p>
                                </BackgroundImage1>
                              </div>
                              <div className="h-[16.5px] opacity-70 overflow-clip relative shrink-0 w-full" data-name="Paragraph">
                                <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] left-0 not-italic text-[11px] text-white top-0 tracking-[0.0645px] whitespace-nowrap">Editable, all platforms</p>
                              </div>
                            </ContainerBackgroundImage>
                          </div>
                        </div>
                      ...
                      <ButtonBackgroundImage>
                        ...
                        <ContainerBackgroundImage additionalClassNames="flex-[174_0_0] h-[36.5px]">
                          <div className="content-stretch flex h-[20px] items-center relative shrink-0 w-full" data-name="Container">
                            <BackgroundImage1 additionalClassNames="w-[123.844px]">
                          ...
                          <BackgroundImageAndText text="Manage team, copy HTML" additionalClassNames="opacity-70 overflow-clip" />
                        </ContainerBackgroundImage>
                      </ButtonBackgroundImage>
                      <ButtonBackgroundImage>
                        ...
                        <ContainerBackgroundImage additionalClassNames="flex-[174_0_0] h-[36.5px]">
                          ...
                          <BackgroundImageAndText text="All approved copy" additionalClassNames="opacity-70 overflow-clip" />
                        </ContainerBackgroundImage>
                      </ButtonBackgroundImage>
                    </div>
                  </div>
                  <div className="bg-[var(--paper)] flex-[1_0_0] h-[827.938px] min-h-px min-w-px relative rounded-[14px]" data-name="Container">
                    <div aria-hidden="true" className="absolute border border-[#D8D0C0] border-solid inset-0 pointer-events-none rounded-[14px]" />
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-start pb-px pt-[33px] px-[33px] relative size-full">
                      <div className="content-stretch flex gap-[12px] h-[61px] items-center pb-px relative shrink-0 w-full" data-name="Container">
                        <div aria-hidden="true" className="absolute border-[#e8ecf2] border-b border-solid inset-0 pointer-events-none" />
                        <ContainerBackgroundImage1 additionalClassNames="bg-[rgba(65,84,163,0.07)] size-[40px]">
                          <IconBackgroundImage>
                            <path d={svgPaths.p1cec7ff0} id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                            <path d={svgPaths.p38772900} id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                            <path d={svgPaths.p27fa8ca0} id="Vector_3" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                          </IconBackgroundImage>
                        </ContainerBackgroundImage1>
                        <BackgroundImage2 additionalClassNames="h-[40px] w-[122.656px]">
                          <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
                            <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#0c0c0c] text-[16px] top-0 tracking-[-0.3125px] whitespace-nowrap">Social Posts</p>
                          </div>
                          <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Paragraph">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#7b8aad] text-[12px] whitespace-nowrap">Editable, all platforms</p>
                          </div>
                        </BackgroundImage2>
                      </div>
                      <div className="content-stretch flex flex-col gap-[16px] h-[676.938px] items-start relative shrink-0 w-full" data-name="SocialPostGenerator">
                        <div className="h-[28px] relative shrink-0 w-full" data-name="Container">
                          <ButtonBackgroundImageAndText text="Thought Leadership" additionalClassNames="left-0 w-[139.672px]" />
                          <ButtonBackgroundImageAndText text="Problem Statement" additionalClassNames="left-[147.67px] w-[135.266px]" />
                          <ButtonBackgroundImageAndText text="Solution" additionalClassNames="left-[290.94px] w-[71.469px]" />
                          <ButtonBackgroundImageAndText text="Announcement" additionalClassNames="left-[370.41px] w-[111.438px]" />
                          <ButtonBackgroundImageAndText1 text="Custom" additionalClassNames="left-[489.84px] w-[68.656px]" />
                        </div>
                        <div className="bg-[#EBE5D8] h-[90.5px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
                          <div className="gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] p-[16px] relative size-full">
                            <div className="col-1 content-stretch flex flex-col gap-[4px] items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                              <BackgroundImageAndText text="Headline" />
                              <TextInputBackgroundImageAndText text="Your Headline Here" />
                            </div>
                            <div className="col-2 content-stretch flex flex-col gap-[4px] items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                              <BackgroundImageAndText text="Supporting Text" />
                              <TextInputBackgroundImageAndText text="Your supporting text" />
                            </div>
                          </div>
                        </div>
                        <div className="h-[28px] relative shrink-0 w-full" data-name="Container">
                          <ButtonBackgroundImageAndText1 text="LinkedIn (1200x627)" additionalClassNames="left-0 w-[142.828px]" />
                          <ButtonBackgroundImageAndText text="Instagram (1080x1080)" additionalClassNames="left-[150.83px] w-[159.641px]" />
                          <ButtonBackgroundImageAndText text="Twitter/X (1200x675)" additionalClassNames="left-[318.47px] w-[146.578px]" />
                          <ButtonBackgroundImageAndText text="Facebook (1200x630)" additionalClassNames="left-[473.05px] w-[151px]" />
                        </div>
                        <div className="h-[430.438px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
                          <div className="overflow-clip rounded-[inherit] size-full">
                            <div className="content-stretch flex flex-col items-start p-px relative size-full">
                              <div className="h-[428.438px] relative shrink-0 w-full" data-name="Container">
                                <div className="overflow-clip rounded-[inherit] size-full">
                                  <div className="content-stretch flex flex-col items-start pr-[240px] relative size-full">
                                    <div className="h-[303.05px] relative shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(152.413deg, rgb(26, 58, 42) 0%, rgb(54, 71, 137) 100%)" }}>
                                      <div className="absolute h-[19.333px] left-[269.65px] top-[107.93px] w-[40.698px]" data-name="Image">
                                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.6982 19.3333">
                                          <g clipPath="url(#clip0_75_1100)" id="Image">
                                            <path d={svgPaths.p119fbe00} fill="var(--fill-0, #1A3A2A)" id="Vector" />
                                            <path d={svgPaths.p14d69580} fill="var(--fill-0, #1A3A2A)" id="Vector_2" />
                                            <path d={svgPaths.p7d1b000} fill="var(--fill-0, #1A3A2A)" id="Vector_3" />
                                            <path d={svgPaths.p2e4b28b2} fill="var(--fill-0, #B8943F)" id="Vector_4" />
                                          </g>
                                          <defs>
                                            <clipPath id="clip0_75_1100">
                                              <rect fill="white" height="19.3333" width="40.6982" />
                                            </clipPath>
                                          </defs>
                                        </svg>
                                      </div>
                                      <div className="absolute content-stretch flex h-[30.156px] items-start left-[179.3px] top-[142.73px] w-[221.389px]" data-name="Paragraph">
                                        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[62.4px] not-italic relative shrink-0 text-[52px] text-center text-white tracking-[0.3301px] whitespace-nowrap">Your Headline Here</p>
                                      </div>
                                      <div className="absolute h-[14.5px] left-[236.58px] top-[180.62px] w-[106.839px]" data-name="Paragraph">
                                        <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[30px] left-[53.5px] not-italic text-[20px] text-[rgba(255,255,255,0.75)] text-center top-[-1.55px] tracking-[-0.4492px] whitespace-nowrap">Your supporting text here</p>
                                      </div>
                                      <div className="absolute bg-[rgba(255,255,255,0.05)] left-[483.33px] size-[145px] top-[-48.33px]" data-name="Container" />
                                      <div className="absolute h-[9.425px] left-[263.05px] top-[279.13px] w-[53.892px]" data-name="Paragraph">
                                        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] left-0 not-italic text-[13px] text-[rgba(255,255,255,0.4)] top-[-0.52px] tracking-[0.9238px] whitespace-nowrap">integratewise.ai</p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div className="h-[36px] relative shrink-0 w-full" data-name="Container">
                          <div className="absolute bg-[#1a3a2a] h-[36px] left-0 rounded-[10px] top-0 w-[163.25px]" data-name="Button">
                            ...
                            <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[93.5px] not-italic text-[12px] text-center text-white top-[10px] whitespace-nowrap">Download LinkedIn</p>
                          </div>
                          <div className="absolute bg-[#EBE5D8] h-[36px] left-[171.25px] rounded-[10px] top-0 w-[250.578px]" data-name="Button">
                            <IconBackgroundImage2 additionalClassNames="left-[16px] top-[11px]">
                              <g clipPath="url(#clip0_75_581)" id="Icon">
                                <path d={svgPaths.p3b016f00} id="Vector" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                                <path d={svgPaths.p23023200} id="Vector_2" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                                <path d={svgPaths.pb269580} id="Vector_3" stroke="var(--stroke-0, #1A3A2A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                              </g>
                              <defs>
                            ...
                            <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[136px] not-italic text-[#1a3a2a] text-[12px] text-center top-[10px] whitespace-nowrap">Batch Export All 4 Platforms (.zip)</p>
                          </div>
                        </div>
                      </div>
                    </div>
