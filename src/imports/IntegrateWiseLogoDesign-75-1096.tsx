...
function ButtonBackgroundImageAndText1({ text, additionalClassNames = "" }: ButtonBackgroundImageAndText1Props) {
  return (
    <div className={clsx("absolute bg-[#4154a3] content-stretch flex h-[28px] items-start px-[12px] py-[6px] rounded-[8px] top-0", additionalClassNames)}>
            ...
            <div className="h-[999.938px] relative shrink-0 w-full" data-name="GeneratorsPage">
              <div className="content-stretch flex flex-col gap-[32px] items-start pt-[40px] px-[40px] relative size-full">
                <div className="h-[60px] relative shrink-0 w-full" data-name="Container">
                  ...
                  <div className="absolute bg-[#f0f2f7] h-[32px] left-[1020.91px] rounded-[10px] top-0 w-[147.094px]" data-name="Button">
                    ...
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-start pb-px pt-[33px] px-[33px] relative size-full">
                      <div className="content-stretch flex gap-[12px] h-[61px] items-center pb-px relative shrink-0 w-full" data-name="Container">
                        ...
                        <ContainerBackgroundImage1 additionalClassNames="bg-[rgba(65,84,163,0.07)] size-[40px]">
                          <IconBackgroundImage>
                            <path d={svgPaths.p1cec7ff0} id="Vector" stroke="var(--stroke-0, #4154A3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                            <path d={svgPaths.p38772900} id="Vector_2" stroke="var(--stroke-0, #4154A3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                            <path d={svgPaths.p27fa8ca0} id="Vector_3" stroke="var(--stroke-0, #4154A3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                          </IconBackgroundImage>
                        </ContainerBackgroundImage1>
                        <BackgroundImage2 additionalClassNames="h-[40px] w-[122.656px]">
                          <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
                            <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[#1b2544] text-[16px] top-0 tracking-[-0.3125px] whitespace-nowrap">Social Posts</p>
                          </div>
                          <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Paragraph">
                      ...
                      <div className="content-stretch flex flex-col gap-[16px] h-[676.938px] items-start relative shrink-0 w-full" data-name="SocialPostGenerator">
                        ...
                        <div className="bg-[#f0f2f7] h-[90.5px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
                              ...
                              <div className="h-[428.438px] relative shrink-0 w-full" data-name="Container">
                                <div className="overflow-clip rounded-[inherit] size-full">
                                  <div className="content-stretch flex flex-col items-start pr-[240px] relative size-full">
                                    <div className="h-[303.05px] relative shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(152.413deg, rgb(65, 84, 163) 0%, rgb(54, 71, 137) 100%)" }}>
                                      <div className="absolute h-[19.333px] left-[269.65px] top-[107.93px] w-[40.698px]" data-name="Image">
                                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.6982 19.3333">
                                          <g clipPath="url(#clip0_75_1100)" id="Image">
                                            <path d={svgPaths.p119fbe00} fill="var(--fill-0, #4154A3)" id="Vector" />
                                            <path d={svgPaths.p14d69580} fill="var(--fill-0, #4154A3)" id="Vector_2" />
                                            <path d={svgPaths.p7d1b000} fill="var(--fill-0, #4154A3)" id="Vector_3" />
                                            <path d={svgPaths.p2e4b28b2} fill="var(--fill-0, #EB4379)" id="Vector_4" />
                                          </g>
                                          <defs>
                        ...
                        <div className="h-[36px] relative shrink-0 w-full" data-name="Container">
                          <div className="absolute bg-[#4154a3] h-[36px] left-0 rounded-[10px] top-0 w-[163.25px]" data-name="Button">
                          ...
                          <div className="absolute bg-[#f0f2f7] h-[36px] left-[171.25px] rounded-[10px] top-0 w-[250.578px]" data-name="Button">
                            <IconBackgroundImage2 additionalClassNames="left-[16px] top-[11px]">
                            ...
                            <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[136px] not-italic text-[#4154a3] text-[12px] text-center top-[10px] whitespace-nowrap">Batch Export All 4 Platforms (.zip)</p>
                          </div>
                        </div>
                      </div>
                    </div>
