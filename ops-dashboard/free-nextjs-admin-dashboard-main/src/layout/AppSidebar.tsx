...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "HR / People", path: "/hr" },
      { name: "IT / Security", path: "/it" },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Tasks & Approvals", path: "/tasks" },
  ...
  },
  {
    ...
    subItems: [
      { name: "Twin", path: "/twin" },
      { name: "Memory View", path: "/memory" },
      { name: "Governance", path: "/governance" },
      { name: "Cognition", path: "/cognition" },
    ],
  },
];
